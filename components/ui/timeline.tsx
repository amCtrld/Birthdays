    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 px-4 md:px-8 lg:px-10">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex flex-col md:flex-row justify-center pt-10 md:pt-40 md:gap-10"
          >
            <div className="sticky flex flex-col md:flex-row z-10 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-gradient-to-br from-muted-foreground/70 to-muted/0 dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-black dark:bg-neutral-800 border-0 dark:border-neutral-700 p-2" />
              </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full flex flex-col md:flex-row md:justify-center">
